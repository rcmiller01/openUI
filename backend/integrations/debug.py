...
class DebugManager:
    ...
    async def start_debug_session(
        self, file_path: str, language: str, config: dict[str, Any] | None = None
    ) -> str | None:
    ...
    async def set_breakpoint(
        self, session_id: str, file_path: str, line: int, condition: str | None = None
    ) -> str | None:
    ...
    async def evaluate_expression(
        self, session_id: str, expression: str, frame_id: str | None = None
    ) -> dict[str, Any] | None:
    ...
    async def get_variables(
        self, session_id: str, frame_id: str | None = None
    ) -> list[Variable]:
    ...
    async def _send_evaluate_request(
        self, session: DebugSession, expression: str, frame_id: str | None = None
    ) -> dict[str, Any]:
    ...
    async def _send_variables_request(
        self, session: DebugSession, frame_id: str | None = None
    ) -> list[Variable]:
    ...
    async def _send_stack_trace_request(
